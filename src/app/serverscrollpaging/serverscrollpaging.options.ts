      ...
      Cfg: {
			...
			Events: {
				onRenderFirstFinish: (evt: {
						sheet: {
							SearchMode: string; showMessageTime: (arg0: string, arg1: number) => void; doSearchPaging: (arg0: {
								url: string;
								param: string; callback: (rtn: any) => void;
							}) => void;
						};
					}) => {
					const param = {
				...
				onBeforeDataLoad: (evt: { sheet: { SuppressMessage: number; showMessage: (arg0: string, arg1: any, arg2: number) => void; }; result: any; }) => {
					let message = '';
