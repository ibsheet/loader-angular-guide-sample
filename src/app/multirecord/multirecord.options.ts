...
const options = [
  {
    ...
    sheetOptions: {
      Cfg: {
			...
			Events: {
				onRenderFirstFinish: (evt: { sheet: { loadSearchData: (arg0: ({ sName: string; sOperation: string; sType: string; sFDay: string; sSido: string; sSiGunGu: string; sWeekdayStart: string; sWeekdayEnd: string; sSaturdayStart: string; sSaturdayEnd: string; sHolidayStart: string; sHolidayEnd: string; sClosed: string; sRentNum: number; sRentDay: number; sArea: number; sPhoneN: string; sLatitude: number; sLongitude: number; sBook: number; sSeries: number; sNonbook: number; sPagelink: string; sAdress: string; } | { sName: string; sOperation: string; sType: string; sFDay: string; sSido: string; sSiGunGu: string; sWeekdayStart: string; sWeekdayEnd: string; sSaturdayStart: string; sSaturdayEnd: string; sHolidayStart: string; sHolidayEnd: string; sClosed: string; sRentNum: number; sRentDay: number; sArea: string; sPhoneN: string; sLatitude: number; sLongitude: number; sBook: number; sSeries: number; sNonbook: number; sPagelink: string; sAdress: string; })[]) => void; }; }) => {
